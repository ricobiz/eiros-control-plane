...
class BatdongsanAdapter:
    name = "batdongsan"
    DEFAULT_SEEDS = (
        "https://batdongsan.com.vn/cho-thue-shophouse-nha-pho-thuong-mai-the-sunset",
        "https://batdongsan.com.vn/cho-thue-shophouse-nha-pho-thuong-mai-sun-premier-village-primavera",
        "https://batdongsan.com.vn/cho-thue-shophouse-nha-pho-thuong-mai-phuong-an-thoi_1",
    )
    DETAIL_PATTERN = re.compile(r"/(?:cho-thue-[^/]+/)?[^/]*-pr\d+$", re.I)
    HOSTS = {"batdongsan.com.vn", "www.batdongsan.com.vn"}
