...
def test_v59_sum_resource_is_separate_from_v57_rollback() -> None:
    from runtime import server_v2

    assert server_v2.PULSE_SUM_URI == "ui://eiros/pulse-anchor-v5-9-authorized-kill.html"
    assert server_v2.PULSE_SUM_VERSION == "0.5.9-authorized-kill"
    ...
    assert "0.5.9-authorized-kill" in v58
