...
def main():
 ...
 assert "minimized" in room_rendered and "EIROS Dial" in room_rendered and "Старая карточка" in room_rendered
 launcher_rendered=server_v2.room_launcher_resource()
 assert "__EIROS_LAUNCHER_BOOTSTRAP_JSON__" not in launcher_rendered
 assert "pulse_poll" in launcher_rendered and "EIROS_OPEN_ROOM" in launcher_rendered and "старая карточка" in launcher_rendered
