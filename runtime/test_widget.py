...
def main():
 ...
 checks=["single placeholder","stable global name","instance binding","bridge methods","static diagnostic","legacy diagnostic compatibility","cache-busted URI","sandbox origin","room DOM bindings","lean room bootstrap","room cache-busted URI","dark control room","operator wake path","scheduled user-origin wake","pending message preservation","legacy v9.14/v9.16/v9.18 aliases","single unified Room mount","compact launcher","launcher pulse","delivery receipts","singleton stale guard","service lamp dashboard","english-only control UI","compact mobile layout","empty room render fix","micro service lamps","widget telemetry"]
