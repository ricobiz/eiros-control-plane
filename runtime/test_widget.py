...
def main():
 ...
 assert "Tunnel" in room_rendered and "Worker" in room_rendered and "Broker" in room_rendered and "Old card" in room_rendered and "Both agents" in room_rendered
